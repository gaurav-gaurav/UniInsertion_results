...
sac = pd.read_csv('SAC_InsertPaper_H-v0_Rewards.csv')
dreamer = pd.read_csv('Dreamer_InsertPaper_H-v0_Rewards.csv') 
...
new_len = len(td3)
new_idx = np.linspace(0,len(dreamer)-1, len(td3))
